# Shader SVG Component — React Integration Guide
...
- Styles: `/styles` (Tailwind config)

If default path for components is NOT `/components/ui`, create it:
```
/components/ui/shader-svg.tsx
```

## Component: `/components/ui/shader-svg.tsx`
...
```bash
npm install framer-motion @paper-design/shaders-react
```
...
3. [ ] Identify required context providers or hooks
4. [ ] Copy-paste code to correct directories
5. [ ] Install external dependencies
6. [ ] Use lucide-react icons if component requires them
